...
window.pokemon = [
  ...
  },
  {
    pokemonName: "Abra",
    pokemonDescription:
      "Abra uses psychic powers while it sleeps. Its dreams affect the powers that the Pokemon wields.",
    pokemonImage:
